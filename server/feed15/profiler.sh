...
java -XX:+FlightRecorder -XX:StartFlightRecording=duration=120s,filename=feed15.jfr -XX:+UnlockExperimentalVMOptions -Djava.security.egd=file:/dev/./urandom -jar build/libs/newsfeed-0.0.1-SNAPSHOT.jar
